...
def train_and_predict(X_train, Y_train, X_test, params):
    ...
    # r2_u degrades (0.3945 late vs 0.4058 early), so the training
    # distribution drifts within the window; a mild geometric emphasis keeps
    # the early window as a physics anchor while biasing the fit toward the
    # most test-like conditions. Ratio 3 is deliberately gentle: the
    # fine-tune already proved a stronger dose of pure recency helps, and
    # this extends the same signal to the full optimization trajectory.
