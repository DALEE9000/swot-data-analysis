...
def _train_member(member_seed, deadline, device, max_epochs, F, C,
    ...
    heteroscedastic NLL and train-time edge augmentation (early stop on
    UNWEIGHTED temporal-val masked MSE of mu — the scored quantity — then
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        # unweighted (and unaugmented) means neither the recency emphasis nor
        # the edge augmentation can game early stopping.
        net.eval()
        with torch.no_grad():
            val_losses = []
