...
# INPUT-NOISE AUGMENTATION (the one new change): std of the isotropic
...
def _train_member(X_t, Y_t, M_t, X_v, Y_v, M_v, X_f, Y_f, M_f, delta, comp_w,
    ...
    INPUT-NOISE AUGMENTATION (the one new change): every training batch has
    isotropic Gaussian noise (std _INPUT_NOISE_STD in standardized units)
